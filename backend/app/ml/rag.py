...
class RAGService:
    ...
    def answer_question(self, question: str, top_k: int = 4, document_id: str = None) -> Dict[str, Any]:
        """
        ...
        Args:
            ...
            document_id: Optional — scope retrieval to specific document
        ...
        if document_id:
            # Document-scoped retrieval — filter by metadata
            try:
